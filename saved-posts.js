...
function createPostCard(post) {
    ...
    return `
        <div class="post-card">
            ${hasImage ? `<img src="${post.imageDataUrl}" alt="Post screenshot" class="post-image" onerror="this.style.display='none'">` : ''}
            <div class="post-content">
                ...
                <div class="post-footer">
                    ...
                    <div class="post-actions">
                        ${hasUrl ? `<button class="action-btn view-btn" data-post-url="${post.url}">View Original</button>` : ''}
